...
export default function Footer() {
  ...
  return (
    <footer className="mt-10">
      {/* Always-running info strip — uses the .marquee-track class defined
          in admin.css (explicit @keyframes there), instead of relying only
          on the Tailwind `animate-marquee` utility, so it's guaranteed to
          actually animate. */}
      <div className="overflow-hidden border-y border-mdn-green/20 bg-mdn-green py-2.5">
      ...
      <div className="border-t border-white/5 bg-mdn-charcoal">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 sm:px-6 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            {/* Same logo image the navbar uses, instead of a separate
                text-only rendering of the brand name — was drifting out
                of sync with the navbar mark. */}
